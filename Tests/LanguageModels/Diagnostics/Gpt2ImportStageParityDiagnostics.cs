...
namespace DevOnBike.Overfit.Tests.LanguageModels.Diagnostics
{
    ...
    public sealed class Gpt2ImportStageParityDiagnostics
    {
        ...
        //        [Fact(Skip = "Manual GPT-2 stage parity diagnostic. Generate PyTorch reference JSON first, remove Skip locally, run once, then restore Skip.")]
        [Fact]
        ...
        private sealed class Gpt2StageReference
        {
            ...
            public int[] StageShape { get; set; } = Array.Empty<int>();
