...
{
    /// <summary>
    /// GPT-1 style single-token feed-forward decode benchmark.
    ///
    /// Shape:
    ///
    /// dModel = 768
    ...
    /// This isolates:
    ///
    /// hidden -> Linear(768, 3072) -> activation -> Linear(3072, 768)
    ///
    /// No attention, no LayerNorm, no residual, no LM head.
    /// </summary>
    [Config(typeof(BenchmarkConfig))]
    [MemoryDiagnoser]
    public class SlmCachedFeedForwardGpt1Benchmark
    {
        ...
        [Params(FeedForwardActivation.GeLU)]
        ...
        public float Decode_FeedForward_Gpt1()
        {
            var checksum = 0f;
