    ...
    public sealed class CifarCnnForwardLayerProfilerTests
    {
        ...
        public void Profile_CifarCnnForward_PerLayer()
        {
            ...
            for (var rep = 0; rep < Warmups + Repeats; rep++)
            {
                ...
                var c1 = conv1.Forward(graph, input);                  var t01 = sw.ElapsedTicks; sw.Restart();
                var b1 = bn1.Forward(graph, c1);                       var t02 = sw.ElapsedTicks; sw.Restart();
                var r1 = graph.Relu(b1);                               var t03 = sw.ElapsedTicks; sw.Restart();
                var c2 = conv2.Forward(graph, r1);                     var t04 = sw.ElapsedTicks; sw.Restart();
                var b2 = bn2.Forward(graph, c2);                       var t05 = sw.ElapsedTicks; sw.Restart();
                var r2 = graph.Relu(b2);                               var t06 = sw.ElapsedTicks; sw.Restart();
                var p1 = graph.MaxPool2D(r2, 32, 32, 32, 2);           var t07 = sw.ElapsedTicks; sw.Restart();
                var c3 = conv3.Forward(graph, p1);                     var t08 = sw.ElapsedTicks; sw.Restart();
                var b3 = bn3.Forward(graph, c3);                       var t09 = sw.ElapsedTicks; sw.Restart();
                var r3 = graph.Relu(b3);                               var t10 = sw.ElapsedTicks; sw.Restart();
                var c4 = conv4.Forward(graph, r3);                     var t11 = sw.ElapsedTicks; sw.Restart();
                var b4 = bn4.Forward(graph, c4);                       var t12 = sw.ElapsedTicks; sw.Restart();
                var r4 = graph.Relu(b4);                               var t13 = sw.ElapsedTicks; sw.Restart();
                var p2 = graph.MaxPool2D(r4, 64, 16, 16, 2);           var t14 = sw.ElapsedTicks; sw.Restart();
                var c5 = conv5.Forward(graph, p2);                     var t15 = sw.ElapsedTicks; sw.Restart();
                var b5 = bn5.Forward(graph, c5);                       var t16 = sw.ElapsedTicks; sw.Restart();
                var r5 = graph.Relu(b5);                               var t17 = sw.ElapsedTicks; sw.Restart();
                var p3 = graph.MaxPool2D(r5, 128, 8, 8, 2);            var t18 = sw.ElapsedTicks; sw.Restart();
                var fl = graph.Reshape(p3, batchSize, 128 * 4 * 4);    var t19 = sw.ElapsedTicks; sw.Restart();
                var d1 = fc1.Forward(graph, fl);                       var t20 = sw.ElapsedTicks; sw.Restart();
                var rd = graph.Relu(d1);                               var t21 = sw.ElapsedTicks; sw.Restart();
                _ = fc2.Forward(graph, rd);                            var t22 = sw.ElapsedTicks;

                if (rep < Warmups) { continue; }
                ticks[0] += t01; ticks[1] += t02; ticks[2] += t03; ticks[3] += t04; ticks[4] += t05;
                ticks[5] += t06; ticks[6] += t07; ticks[7] += t08; ticks[8] += t09; ticks[9] += t10;
                ticks[10] += t11; ticks[11] += t12; ticks[12] += t13; ticks[13] += t14; ticks[14] += t15;
                ticks[15] += t16; ticks[16] += t17; ticks[17] += t18; ticks[18] += t19; ticks[19] += t20;
                ticks[20] += t21; ticks[21] += t22;
            }
