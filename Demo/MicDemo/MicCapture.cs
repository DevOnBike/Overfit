...
{
    /// <summary>
    /// Microphone capture via the built-in Windows <c>winmm</c> <c>waveIn</c> API (P/Invoke — no NuGet, no
    /// native binary shipped). Records a fixed number of seconds of 16 kHz mono 16-bit PCM and returns it as
    /// float in [-1, 1], ready for the Whisper frontend. Demo-only; the core engine stays platform-neutral.
    /// </summary>
