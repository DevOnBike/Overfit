...
namespace DevOnBike.Overfit.Anomalies.Monitoring.Contracts
{
    ...
    public readonly struct MetricSnapshot
    {
        ...
        /// </summary>
        public float MemoryWorkingSetBytes
        {
            get; init;
        }
        ...
        /// </summary>
        public float ThreadPoolQueueLength
        {
            get; init;
        }
