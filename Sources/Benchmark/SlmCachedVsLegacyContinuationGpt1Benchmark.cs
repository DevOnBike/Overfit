...
{
    /// <summary>
    /// GPT-1 style continuation-only benchmark.
    ///
    ...
    ///
    /// This is the benchmark that best represents hot-path autoregressive decode
    /// after the prompt has already been cached.
    /// </summary>
    [Config(typeof(BenchmarkConfig))]
    [MemoryDiagnoser]
    public class SlmCachedVsLegacyContinuationGpt1Benchmark : IDisposable
    {
