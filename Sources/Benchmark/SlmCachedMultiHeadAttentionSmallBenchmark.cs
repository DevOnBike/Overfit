...
{
    /// <summary>
    /// Small SLM cached multi-head decode benchmark.
    ///
    /// Shape:
    ///
    /// dModel = 64
    ...
    /// headDim = 16
    ///
    /// This is useful for Nano/Small demo models and for fast iteration.
    /// </summary>
    [Config(typeof(BenchmarkConfig))]
    [MemoryDiagnoser]
    public class SlmCachedMultiHeadAttentionSmallBenchmark : IDisposable
    {
        ...
        public float Decode_MultiHead_Small()
        {
            var checksum = 0f;
