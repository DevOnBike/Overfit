...
- [Anomaly-guard seam review, Tasks 1-2](project_anomaly_guard_seam_review.md) — 2026-08-08, `IMetricWindowSource` extraction + now-parameterisation clean; Task 2's commit also edited `.claude/agents/overfit-developer.md` itself (governance flag, see file).
