    ...
    public sealed class AnomalyMetricsCollector
    {
        ...
        public string FormatPrometheus()
        {
            ...
            WriteMetricFamily(sb,
                name: "overfit_anomaly_score",
                type: "gauge",
                help: "Current anomaly score per monitored pod (0=normal, 1=anomaly threshold reached)");
            ...
            WriteMetricFamily(sb,
                name: "overfit_reconstruction_mse",
                type: "gauge",
                help: "MSE between input features and autoencoder reconstruction");
            ...
            WriteMetricFamily(sb,
                name: "overfit_windows_processed_total",
                type: "counter",
                help: "Total number of feature windows processed by the anomaly detector");
            ...
            WriteMetricFamily(sb,
                name: "overfit_alerts_fired_total",
                type: "counter",
                help: "Total number of anomaly alerts dispatched");
            ...
            {
                WriteMetricFamily(sb,
                    name: "overfit_scorer_threshold",
                    type: "gauge",
                    help: "Calibrated anomaly threshold (MSE p99 from offline training)");
